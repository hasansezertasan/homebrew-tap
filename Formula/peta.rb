class Peta < Formula
  ...
  url "https://files.pythonhosted.org/packages/91/fe/4e57bcf70c6d885385c1dee716a09182a60faedb27242b9b731d302d880c/peta-0.1.0.tar.gz"
  ...
  test do
    assert_match version.to_s, shell_output("#{bin}/peta --version")
  end
end
